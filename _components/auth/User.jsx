function User({ onClick, session, hello, Profile, admin }) {
  console.log(session)
      ...
      <div className="fixed left-0 w-full h-full overflow-hidden items-center z-20">
        ...
        <div className="search fixed  xl:right-[35%] xl:left-[35%] md:right-[25%] md:left-[25%] left-[10%] right-[10%] top-28">
          <div className="flex items-center  w-full justify-between gap-2">
            ...
            <button className="btn !p-1 m-1" onClick={() => onClick()}>
              <svg
          ...
          <div className="flex justify-between ">
            {session.user ? (
              <a href="/profile" className="btn m-1">
                {Profile}
              </a>
            ) : null}

            {session.user.role && session.user.role === "admin" ? (
              <a href="/admin" className="btn m-1">
                {admin}
              </a>
            ) : null}
          </div>
